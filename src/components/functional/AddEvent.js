  ...
  return (
    <>
      <button
        ...
        className={
          openSideBar
            ? "hidden z-50 absolute sm:block items-center p-3 border border-transparent rounded-full shadow-lg left-16 top-3 text-white bg-fuchsia-600 hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition transform delay-75 translate-x-72"
            : "hidden z-50 absolute sm:block items-center p-3 border border-transparent rounded-full shadow-lg left-16 top-3  text-white bg-fuchsia-600 hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition transform delay-75 ease-in-out "
        }
        onClick={() => {
